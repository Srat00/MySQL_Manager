...
try:
    ...
    while(True):
        ...
        if (int(select) == 1):
            ...
            table = input()
            while(True):
                print("삽입할 데이터를 입력하십시오. \n >> ", end = "")
                data = input()                
                quarry = "INSERT INTO " + table + " VALUES (" + data + ")"
                
                try:
                    cursor.execute(quarry)
                    print("데이터를 삽입했습니다. 계속 삽입하시려면 1을 입력해주십시오.\n >> ", end = "")
                    select = input()
                    if(select != '1'):
                        break
                except Exception as e:
                    print("데이터 삽입에 실패하였습니다. 데이터를 확인하십시오.", e, "\n\n")
        ...
        #데이터 수정
            ...
            while(True):
                ...
                try:
                    cursor.execute(quarry)
                    print("데이터를 수정했습니다. 계속 수정하시려면 1을 입력해주십시오.\n >> ", end = "")
                    select = input()
                    if(select != '1'):
                        break
                except Exception as e:
                    print("데이터 수정에 실패하였습니다. 데이터를 확인하십시오.", e, "\n\n")
        ...
        #데이터 삭제
            ...
            while(True):
                ...
                try:
                    cursor.execute(quarry)
                    print("데이터를 삭제했습니다. 계속 삭제하시려면 1을 입력해주십시오.\n >> ", end = "")
                    select = input()
                    if(select != '1'):
                        break
                except Exception as e:
                    print("데이터 삭제에 실패하였습니다. 조건을 확인하십시오.", e, "\n\n")
        ...
        #데이터 검색     
            ...
            while(True):
                ...
                try:
                    ...
                    print("데이터를 검색했습니다. 계속 검색하시려면 1를 입력해주십시오.\n >> ", end = "")
                    select = input()
                    if(select != '1'):
                        break
                    ...
                    print("데이터 조회에 실패하였습니다. 조건을 확인하십시오.", e, "\n\n")
                
        
        elif (int(select) == 0):
            while(True):
                print("수정사항을 저장하시겠습니까? Y/N")
                select = input()
...
#연결 실패            
    ...
    print("데이터베이스와 연결중 오류가 발생했습니다. 프로그램을 종료합니다.", e)
